    ...
    <div className="sb-logo-wrap">
      <div>
        <div style={{ lineHeight: 1 }}>
          <span style={{ fontSize: 16, fontWeight: 700, color: "#6a8193" }}>Nord</span>
          <span style={{ fontSize: 16, fontWeight: 700, color: "#ffffff" }}>Sheet</span>
        </div>
        <div style={{ fontSize: 9, letterSpacing: "1.8px", color: "#6a8193", fontWeight: 600, marginTop: 2 }}>
          SNABB PRECISION
        </div>
      </div>
    </div>
